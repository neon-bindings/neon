...
extern "system" {
    ...
    pub fn Nan_Object_GetIsolate(obj: Local) -> *mut Isolate;
    ...
    pub fn Nan_Get_Index(out: &mut Local, object: Local, index: u32) -> bool;
    pub fn Nanny_Set_Index(out: &mut bool, object: Local, index: u32, val: Local) -> bool;
    pub fn Nanny_Get_Bytes(out: &mut Local, object: Local, key: *const u8, len: i32) -> bool;
    pub fn Nanny_Set_Bytes(out: &mut bool, object: Local, key: *const u8, len: i32, val: Local) -> bool;
    pub fn Nan_Get(out: &mut Local, object: Local, key: Local) -> bool;
    pub fn Nan_Set(out: &mut bool, object: Local, key: Local, val: Local) -> bool;
    ...
    pub fn Nan_Value_ToString(out: &mut Local, value: Local) -> bool;

    pub fn Nan_NewBuffer(out: &mut Local, size: u32) -> bool;
    pub fn Node_Buffer_Data<'a, 'b>(out: &'a mut Buf<'b>, obj: Local);
    ...
    pub fn Nanny_ExecModuleBody(kernel: *mut c_void, callback: extern fn(*mut c_void, *mut c_void, *mut c_void), exports: Local, scope: *mut c_void);
