...
extern "C" void* Neon_EventHandler_New(v8::Local<v8::Value> self, v8::Local<v8::Function> callback) {
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  return new neon::EventHandler(isolate, self, callback);
}

extern "C" void Neon_EventHandler_Call(void *thread_safe_cb, void *rust_callback, Neon_EventHandlerHandler handler) {
