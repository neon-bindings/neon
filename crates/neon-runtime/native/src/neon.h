...
extern "C" {
  ...
  typedef void (*Neon_EventHandlerHandler)(v8::Local<v8::Value> self, v8::Local<v8::Value> callback, void* arg_cb);

  void* Neon_EventHandler_New(v8::Local<v8::Value> self, v8::Local<v8::Function> callback);
  void Neon_EventHandler_Call(void* thread_safe_cb, void* rust_callback, Neon_EventHandlerHandler handler);
